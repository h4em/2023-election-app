...
wojewodztwo_df.to_sql('city', con=db_engine, if_exists='replace', index=False)
gmina_df.to_sql('city', con=db_engine, if_exists='replace', index=False)
powiat_df.to_sql('city', con=db_engine, if_exists='replace', index=False)
...
# print(gmina_df)
# print(powiat_df)
# print(wojewodztwo_df)
# print(komitet_table_df)
